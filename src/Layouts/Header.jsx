...
const Header = () => {
  ...
  const MobileHeader = () => (
    <div className="md:hidden">
      <header
        className={cn(
          "fixed top-0 left-0 right-0 z-1000 transition-all duration-500 pb-5  border-b rounded-b-[28px]",
          isScrolled
            ? "bg-[#1a1a24]/95 backdrop-blur-md shadow-lg"
            : "bg-[#1a1a24]"
        )}
            ...
            <div className="flex items-center gap-2 md:gap-4 ml-auto">
              ...
              <Link to="/cart" className="relative">
                <motion.button
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.95 }}
                  className="p-2 text-white hover:text-orange-500 transition-colors rounded-full hover:bg-white/10"
                >
          ...
          <div className="pb-0 md:pb-4">
            <div className="relative">
              ...
              <input
                ...
                onClick={() => setIsSearchOpen(true)}
                readOnly
                className="w-full bg-[#2d2d3a] text-white placeholder-gray-400 rounded-full py-2.5 md:py-3 pl-12 pr-4 text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-orange-500/50 cursor-pointer"
              />
            </div>
          </div>
        </div>
