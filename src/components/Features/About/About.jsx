    ...
    <div className="min-h-screen">
      ...
      ></div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 text-start">
          <h1 className="text-5xl md:text-5xl font-extrabold mb-6 leading-tight">
            About <span className="bg-linear-to-tr from-[#FF7203] to-[#FF9A03] bg-clip-text text-transparent">SneakerHub</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-start gap-4">
            ...
            <button className="px-8 py-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-bold rounded-full transition-all duration-300 border border-white/20">
              Meet the Team
            </button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-6 rounded-2xl bg-linear-to-br from-purple-100 to-white border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="text-4xl font-bold md:text-5xl bg-linear-to-tr from-[#FF7203] to-[#FF9A03] bg-clip-text text-transparent mb-2">{stat.number}</div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
  <span className="inline-block italic py-2 bg-linear-to-tr from-[#FF7203] to-[#FF9A03] bg-clip-text text-transparent rounded-full text-sm font-bold mb-4">
    OUR STORY
  </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mb-4">
              What Makes Us <span className="bg-linear-to-tr from-[#FF7203] to-[#FF9A03] bg-clip-text text-transparent">Different</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="group p-8 rounded-2xl bg-linear-to-br from-gray-50 to-white border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="w-16 h-16 bg-linear-to-tr from-[#FF7203] to-[#FF9A03] rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300">
                  {value.icon}
                </div>
      ...
      <section className="py-24 bg-linear-to-br from-gray-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            ...
            <h2 className="text-4xl font-black text-gray-900 mb-4">
              Meet The <span className="bg-linear-to-tr from-[#FF7203] to-[#FF9A03] bg-clip-text text-transparent">Experts</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mr-auto">
            ...
            {team.map((member, index) => (
              <div key={index} className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-linear-to-t from-orange-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-6">
                    <div className="flex gap-3">
                      <button className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-orange-600 hover:bg-orange-500 hover:text-white transition-colors duration-300">
                ...
                <div className="p-6">
                  ...
                  <p className="bg-linear-to-tr from-[#FF7203] to-[#FF9A03] bg-clip-text text-transparent font-semibold text-sm mb-3">{member.role}</p>
