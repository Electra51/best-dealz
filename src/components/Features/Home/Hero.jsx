...
//               <p className="text-[12px] text-[rgba(240,248,255,0.6)] uppercase tracking-[1px] mb-1 m-0">
//                 Hot Deal
//               </p>
...
const Hero = () => {
  return (
    <section className="relative bg-linear-to-br from-[#1a1a24] via-[#2d1b3d] to-[#1a1a24] flex items-center justify-center overflow-hidden py-8 md:py-13 mt-40 md:mt-20 rounded-4xl md:rounded-none mx-4 md:mx-0">
      {/* Background Effects */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
        ...
        <div className="md:hidden">
          ...
          <div className="grid grid-cols-2 gap-3 md:pb-8">
            ...
            <div className="px-2 w-full">
              ...
              {/* </div> */}
              {/* <h1 className="text-2xl font-bold text-white leading-tight mb-3 mt-3 md:mt-0">
                Find Your Pair
                <br />
                 to {" "}
                <span className="bg-linear-to-tr from-[#FF7203] to-[#FF9A03] bg-clip-text text-transparent">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 xl:gap-20 items-center w-full z-10">
            <div>
              ...
              <div className="flex gap-5 mb-15">
                <Link
                  to="/shop"
                  className="group inline-flex items-center justify-center gap-2.5 py-3 px-6 rounded-full text-[16px] font-semibold no-underline transition-all duration-300 cursor-pointer max-md:w-full bg-gradient-to-br from-[#FF7203] to-[#FF9A03] text-white shadow-[0_10px_30px_rgba(255,165,0,0.3)] hover:-translate-y-0.75 hover:shadow-[0_15px_40px_rgba(255,165,0,0.4)]"
                >
                  Shop Now
                  <svg
                    className="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1.25"
              ...
              <div className="flex items-center justify-start gap-10">
                <div className="text-start">
                  <h3 className="m-0 text-[30px] font-extrabold bg-gradient-to-tr from-[#FF7203] to-[#FF9A03] bg-clip-text text-transparent mb-1">
                    500+
                  </h3>
                  <p className="m-0 text-[14px] text-[rgba(240,248,255,0.7)] tracking-[1px]">
                    Premium Products
